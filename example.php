...
<p>Content of the first child in the list of items : <?php echo $title = $html_dom->find('#content ol', 0)->first_child()->innertext; ?></p>
<p>Content of the third child in the list of items : <?php echo $title = $html_dom->find('#content ol li')->offsetGet(2)->innertext; ?></p>